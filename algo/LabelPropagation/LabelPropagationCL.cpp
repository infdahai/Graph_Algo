...
int LabelPropagationCL<VertexValueType, MessageValueType>::roundWorkSize(int group_size, int total_size)
{
...
void LabelPropagationCL<VertexValueType, MessageValueType>::Init(int vCount, int eCount, int numOfInitV)
{
    ...
    //loadAndBuildProgram(gpu_context, "../algo/LabelPropagation/LabelPropagationCL_kernel.out");
...
template <typename VertexValueType, typename MessageValueType>
int LabelPropagationCL<VertexValueType, MessageValueType>::MSGGenMerge_array(int vCount, int eCount, const Vertex *vSet, const Edge *eSet, int numOfInitV, const int *initVSet, const VertexValueType *vValues, MessageValueType *mValues)
{
...
template <typename VertexValueType, typename MessageValueType>
int LabelPropagationCL<VertexValueType, MessageValueType>::MSGApply_array(int vCount, int eCount, Vertex *vSet, int numOfInitV, const int *initVSet, VertexValueType *vValues, MessageValueType *mValues)
{
    //MSGApply_array(g.vCount, g.eCount, &g.vList[0], 0, &initVSet[0], &g.verticesValue[0], mValues);
...
template <typename VertexValueType, typename MessageValueType>
void LabelPropagationCL<VertexValueType, MessageValueType>::checkErrorFileLine(int errNum, int expected, const char *file, const int lineNumber)
{
    if (errNum != expected)
    {
...
template <typename VertexValueType, typename MessageValueType>
cl_device_id LabelPropagationCL<VertexValueType, MessageValueType>::getMaxFlopsDev(cl_context cxGPUContext)
{
